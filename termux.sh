...
eval "cat ~/Shadow/assets/download.txt"
printf "\n\n\033[1;35mShadow is being installed... ✨\033[0m"
...
eval "cd && git clone https://github.com/Viciu3/Shadow && cd Shadow"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && cd ~/Shadow && python3 -m hikka' > ~/.bash_profile"
